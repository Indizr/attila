...
A content-focused, responsive theme for [Ghost](http://github.com/tryghost/ghost/). Original theme by Peter Amende, with some light modifications in this fork by Peter A. McKay for deployment on the [Indizr](https://blog.indizr.com) website.
